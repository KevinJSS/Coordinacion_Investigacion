...
ActiveRecord::Schema[7.0].define(version: 2022_09_24_005214) do
  ...
  add_foreign_key "agreements", "articles", on_delete: :cascade
  add_foreign_key "articles", "projects"
  add_foreign_key "articles", "records", on_delete: :cascade
